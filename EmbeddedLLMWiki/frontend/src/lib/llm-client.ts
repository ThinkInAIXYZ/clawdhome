...
export async function streamChat(
  ...
  // In ClawdHome, route LLM calls through the native host bridge to avoid
  // browser CORS failures against third-party model endpoints.
  if (typeof window !== "undefined" && window.ClawdHomeWiki) {
    try {
