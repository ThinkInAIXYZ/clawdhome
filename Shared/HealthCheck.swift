    ...
    static func openClawItem(
        ...
        if !userAutostartEnabled {
            return DiagnosticItem(
                ...
                group: .gateway,
                severity: "info",
                title: "OpenClaw Gateway 用户自启动已关闭",
                detail: "该实例可能处于冻结状态或已手动关闭自启动，跳过自启动检查",
                fixable: false,
                fixed: nil,
                fixError: nil,
                latencyMs: nil
    ...
    static func hermesItem(
        ...
        if !userAutostartEnabled {
            return DiagnosticItem(
                ...
                group: .gateway,
                severity: "info",
                title: "Hermes Gateway 用户自启动已关闭",
                detail: "该实例可能处于冻结状态或已手动关闭自启动，跳过 Hermes profile \(profileLabel) 自启动检查",
                fixable: false,
                fixed: nil,
                fixError: nil,
                latencyMs: nil
