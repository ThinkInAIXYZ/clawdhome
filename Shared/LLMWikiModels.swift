...
enum LLMWikiPaths {
    ...
    static let bundleIdentifier = "com.llmwiki.app"
    static let appBundlePath = "/Applications/LLM Wiki.app"
    ...
    static func appStatePath(for adminUsername: String) -> String {
        "/Users/\(adminUsername)/Library/Application Support/com.llmwiki.app/app-state.json"
    }
}
